    ...
    <div className="min-h-[80vh] flex items-center justify-center p-4">
      <div className="w-full max-w-md p-8 rounded-3xl glass-card border border-slate-200 dark:border-slate-800 bg-white/95 dark:bg-slate-950/90 text-slate-900 dark:text-white shadow-2xl space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Join Instangalog</h1>
          <p className="text-xs text-slate-500 dark:text-slate-400">Create your multimedia social account</p>
        </div>
        ...
        <div className="relative my-3">
          ...
          <div className="relative flex justify-center text-[10px] uppercase">
            <span className="bg-white dark:bg-slate-950 px-2 text-slate-400">Or Email Registration</span>
          </div>
        </div>
        ...
        <div className="pt-2 text-center text-xs text-slate-500 dark:text-slate-400">
          ...
          <Link href="/login" className="text-slate-900 dark:text-white hover:underline font-bold">
            Sign in
          </Link>
        </div>
      </div>
